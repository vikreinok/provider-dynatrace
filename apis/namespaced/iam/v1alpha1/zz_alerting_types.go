...
type AlertingInitParameters struct {
	...
	// +crossplane:generate:reference:type=ManagementZoneV2
	ManagementZone *string `json:"managementZone,omitempty" tf:"management_zone,omitempty"`

	// Reference to a ManagementZoneV2 to populate managementZone.
	// +kubebuilder:validation:Optional
	ManagementZoneRef *v1.NamespacedReference `json:"managementZoneRef,omitempty" tf:"-"`

	// Selector for a ManagementZoneV2 to populate managementZone.
	// +kubebuilder:validation:Optional
