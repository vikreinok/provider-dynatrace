...
type AttributeConditionsInitParameters struct {

	// (Block Set, Min: 1) Attribute conditions (see below for nested schema)
...
type AttributeRuleInitParameters struct {
	...
	AttributeConditions []AttributeConditionsInitParameters `json:"attributeConditions,omitempty" tf:"attribute_conditions,omitempty"`
	...
	// (Boolean) Apply to custom devices in a custom device group
	// Apply to custom devices in a custom device group
	CustomDeviceGroupToCustomDevicePropagation *bool `json:"customDeviceGroupToCustomDevicePropagation,omitempty" tf:"custom_device_group_to_custom_device_propagation,omitempty"`
	...
	// (Boolean) Apply to processes running on matching hosts. entity_type must be set to HOST
	...
	// (Boolean) Apply to underlying hosts of matching process groups. entity_type must be set to PROCESS_GROUP
	...
	// (Boolean) Apply to all services provided by the process groups. entity_type must be set to PROCESS_GROUP
	...
	// (Boolean) Apply to underlying hosts of matching services. entity_type must be set to SERVICE
	...
	// (Boolean) Apply to underlying process groups of matching services. entity_type must be set to SERVICE
...
type AttributeRuleObservation struct {
	...
	// (Block List, Min: 1, Max: 1) no documentation available (see below for nested schema)
	// no documentation available
	AttributeConditions []AttributeConditionsObservation `json:"attributeConditions,omitempty" tf:"attribute_conditions,omitempty"`
...
type AttributeRuleParameters struct {
	...
	// no documentation available
	// +kubebuilder:validation:Optional
	AttributeConditions []AttributeConditionsParameters `json:"attributeConditions" tf:"attribute_conditions,omitempty"`
...
type DimensionConditionsConditionInitParameters struct {

	// (String) Possible Values: DIMENSION, LOG_FILE_NAME, METRIC_KEY
	...
	// (String) Possible Values: BEGINS_WITH, EQUALS
	// Possible Values: `BEGINS_WITH`, `EQUALS`
	RuleMatcher *string `json:"ruleMatcher,omitempty" tf:"rule_matcher,omitempty"`
...
type DimensionConditionsConditionParameters struct {
	...
	// Possible Values: `BEGINS_WITH`, `EQUALS`
	// +kubebuilder:validation:Optional
	RuleMatcher *string `json:"ruleMatcher" tf:"rule_matcher,omitempty"`
...
type DimensionConditionsInitParameters struct {

	// (Block Set, Min: 1) Attribute conditions (see below for nested schema)
	// Dimension conditions
	Condition []DimensionConditionsConditionInitParameters `json:"condition,omitempty" tf:"condition,omitempty"`
}
...
type DimensionConditionsObservation struct {
	...
	// (Block Set, Min: 1) Attribute conditions (see below for nested schema)
	// Dimension conditions
	Condition []DimensionConditionsConditionObservation `json:"condition,omitempty" tf:"condition,omitempty"`
}
...
type DimensionConditionsParameters struct {
	...
	// Dimension conditions
	// +kubebuilder:validation:Optional
	Condition []DimensionConditionsConditionParameters `json:"condition" tf:"condition,omitempty"`
}

type DimensionRuleInitParameters struct {

	// (String) Possible Values: ANY, LOG, METRIC
	// Possible Values: `ANY`, `LOG`, `METRIC`
	AppliesTo *string `json:"appliesTo,omitempty" tf:"applies_to,omitempty"`

	// (Block List, Max: 1) Conditions (see below for nested schema)
	// Conditions
	DimensionConditions []DimensionConditionsInitParameters `json:"dimensionConditions,omitempty" tf:"dimension_conditions,omitempty"`
}
...
type DimensionRuleObservation struct {
	...
	// (Block List, Max: 1) Conditions (see below for nested schema)
	// Conditions
	DimensionConditions []DimensionConditionsObservation `json:"dimensionConditions,omitempty" tf:"dimension_conditions,omitempty"`
}
...
type DimensionRuleParameters struct {
	...
	// Conditions
	// +kubebuilder:validation:Optional
	DimensionConditions []DimensionConditionsParameters `json:"dimensionConditions,omitempty" tf:"dimension_conditions,omitempty"`
}

type ManagementZoneV2InitParameters struct {
	...
	// if there are policies that are referencing this Management zone, they will need to be adapted to the new name!
	...
	// Rules
	Rules []ManagementZoneV2RulesInitParameters `json:"rules,omitempty" tf:"rules,omitempty"`
}

type ManagementZoneV2Observation struct {
	...
	// (Block List, Max: 1) Rules (see below for nested schema)
	// Rules
	Rules []ManagementZoneV2RulesObservation `json:"rules,omitempty" tf:"rules,omitempty"`
}

type ManagementZoneV2Parameters struct {
	...
	// Rules
	// +kubebuilder:validation:Optional
	Rules []ManagementZoneV2RulesParameters `json:"rules,omitempty" tf:"rules,omitempty"`
}

type ManagementZoneV2RulesInitParameters struct {

	// (Block Set, Min: 1) A management zone rule (see below for nested schema)
	// A management zone rule
	Rule []RulesRuleInitParameters `json:"rule,omitempty" tf:"rule,omitempty"`
}

type ManagementZoneV2RulesObservation struct {
...
type ManagementZoneV2RulesParameters struct {
...
type RulesRuleInitParameters struct {
	...
	// (Block List, Max: 1) no documentation available (see below for nested schema)
	// no documentation available
	DimensionRule []DimensionRuleInitParameters `json:"dimensionRule,omitempty" tf:"dimension_rule,omitempty"`
	...
	// (String) Possible Values: DIMENSION, ME, SELECTOR
...
type RulesRuleObservation struct {
	...
	// (Block List, Max: 1) no documentation available (see below for nested schema)
	// no documentation available
	DimensionRule []DimensionRuleObservation `json:"dimensionRule,omitempty" tf:"dimension_rule,omitempty"`
...
type RulesRuleParameters struct {
	...
	// no documentation available
	// +kubebuilder:validation:Optional
	DimensionRule []DimensionRuleParameters `json:"dimensionRule,omitempty" tf:"dimension_rule,omitempty"`
...
// ManagementZoneV2Spec defines the desired state of ManagementZoneV2
type ManagementZoneV2Spec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            ManagementZoneV2Parameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ManagementZoneV2InitParameters `json:"initProvider,omitempty"`
}

// ManagementZoneV2Status defines the observed state of ManagementZoneV2.
type ManagementZoneV2Status struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ManagementZoneV2Observation `json:"atProvider,omitempty"`
}
...
// ManagementZoneV2 is the Schema for the ManagementZoneV2s API. The resource
...
type ManagementZoneV2 struct {
	...
	Spec   ManagementZoneV2Spec   `json:"spec"`
	Status ManagementZoneV2Status `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ManagementZoneV2List contains a list of ManagementZoneV2s
type ManagementZoneV2List struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ManagementZoneV2 `json:"items"`
}

// Repository type metadata.
var (
	ManagementZoneV2_Kind             = "ManagementZoneV2"
	ManagementZoneV2_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ManagementZoneV2_Kind}.String()
	ManagementZoneV2_KindAPIVersion   = ManagementZoneV2_Kind + "." + CRDGroupVersion.String()
	ManagementZoneV2_GroupVersionKind = CRDGroupVersion.WithKind(ManagementZoneV2_Kind)
)

func init() {
	SchemeBuilder.Register(&ManagementZoneV2{}, &ManagementZoneV2List{})
}
